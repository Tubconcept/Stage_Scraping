...
PRODUCTS: dict[str, str] = {
    "id": "",
    "product_fournisseur": "",
    "product_reference_fournisseur": "div.c-reference__ref",
    "product_ean": "span.code_ean span.code_ean_value, span.code_ean_value",
    "product_reference_fabricant": "tr#characCodeProvider td",
    "product_brand": "div.u-display-contents img.product-brand",
    "product_brand_logo_url": "img.product-brand",
    ...
    "product_eco_label": "div.u-1\\/8.u-padding-right-16.u-padding-top-2 img",
    ...
    "product_attributes": "#characteristicsTable > tbody > tr",
    ...
    "product_cross_sell": "div.article-preview__link a article[data-productcode]",
    "product_status": "div.c-promo-highlight_promo",
}
...
PRODUCTS_COLLECTION: dict[str, str] = {
    ...
    "subcategory_link": "a.c-universes-preview__link",
